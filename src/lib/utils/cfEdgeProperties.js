    ...
    return cf ?
        {
            ...
            ...((typeof cf.longitude === 'undefined' ? null : cf.longitude) && { longitude: cf.longitude }),
            ...
            ...((typeof cf.regionCode === 'undefined' ? null : cf.regionCode) && { regionCode: cf.regionCode }),

            //Postal code of the incoming request, for example, "78701".
            ...((typeof cf.postalCode === 'undefined' ? null : cf.postalCode) && { postalCode: cf.postalCode }), //Código Postal
            ...
            ...((typeof cf.metroCode === 'undefined' ? null : cf.metroCode) && { metroCode: cf.metroCode }),

            //Continent of the incoming request, for example, "NA".
            ...((typeof cf.continent === 'undefined' ? null : cf.continent) && { continent: cf.continent }),
            ...
            ...((typeof cf.botManagement === 'undefined' ? null : cf.botManagement) && { botManagement: cf.botManagement }),

            /* If the country of the incoming request is in the EU, this will return "1". Otherwise, this property will
            be omitted. */
            ...((typeof cf.isEUCountry === 'undefined' ? null : cf.isEUCountry) && { isEUCountry: cf.isEUCountry }),
            ...
            ...((typeof cf.asOrganization === 'undefined' ? null : cf.asOrganization) && { asOrganization: cf.asOrganization }),
        }
        : {}
